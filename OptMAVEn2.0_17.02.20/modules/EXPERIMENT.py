...
class Experiment(object):
    ...
    def OptMAVEn_status_list(self):
        return ["initialize", "cull clashes", "MAPs energies",
                "MAPs energies callback", "select parts callback"]
    #mfa#
    ...
    def incr_OptMAVEn_status(self):
        ...
        status = self.OptMAVEn_status_list()[self.OptMAVEn_status_list().index(
                old_status) + 1]
