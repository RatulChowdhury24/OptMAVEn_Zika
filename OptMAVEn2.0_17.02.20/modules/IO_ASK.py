    ...
    if grid_range is None:
        ...
        for what, default in zip(["z rotation angle", "x center", "y center",
            ...
            while answer is None:
                ...
                answer = [FUNCTIONS.answer_question("What should the {} {} be? The default "
                        "is {}. ".format(spec, what, defspec), "float") for spec,
                        defspec in zip(["minimum", "maximum", "step"], default)]
                ...
                # The z rotation angle must be within the range [0, 360).
                    ...
                    answer = None
            # Include the maximum value in the range.
            answer[1] += answer[2]
            grid_range.append(answer)
    experiment["Optmaven Grid"] = [np.arange(*what) for what in grid_range]
