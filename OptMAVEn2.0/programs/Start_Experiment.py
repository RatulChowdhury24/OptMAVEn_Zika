...
InstallFolder = "/gpfs/scratch/mfa5147/BENCHMARKING_1.0_vs_2.0/OptMAVEn2.0"
...
python {i}/programs/Optmaven2.0.py
echo "Job ended at $(date)""".format(h=hours, f=experiment["Folder"], i=
        InstallFolder))
