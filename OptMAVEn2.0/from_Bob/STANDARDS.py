...
# The location where the python interface with CPLEX is stored
...
supportedPrograms = ['IPRO', 'OptGraft', 'OptCDR', 'OptZyme', "Mutator"]
...
# The preferred method of accessing CPLEX to identify optimal solutions. The
# options are GAMS and CPLEX
defaultSolver = "CPLEX"
...
RotamerLibraryPath = "/gpfs/group/c/cdm/rotlib/"
